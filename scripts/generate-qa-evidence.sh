...
| first-use | pending-human-verification | `./scripts/compile-and-run.sh --qa-state first-use` | Menu shows setup before any saved context exists; the short setup content stays near the top, and the footer keeps clear spacing below it without forcing a tall menu. | pending-human-verification | `docs/assets/qa/phase-07-first-use.png` | Screenshot or visible menu check may require human action. | Do not mark complete without visible evidence. |
| empty-watchlist | pending-human-verification | `./scripts/compile-and-run.sh --qa-state empty-watchlist` | Menu shows setup because the QA fixture context has no selected namespaces; the short setup content stays near the top, and the footer keeps clear spacing below it without forcing a tall menu. | pending-human-verification | `docs/assets/qa/phase-07-empty-watchlist.png` | Screenshot or visible menu check may require human action. | Do not mark complete without visible evidence. |
