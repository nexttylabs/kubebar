...
run_extract "$case_dir/CHANGELOG.md" "v0.2.0" > "$case_dir/v-prefixed-notes.md"
assert_contains "$case_dir/v-prefixed-notes.md" "- Add release-note validation."
...
case_dir="$TMP_DIR/v-prefixed-prepare"
mkdir -p "$case_dir/fragments"
write_changelog "$case_dir/CHANGELOG.md"
printf 'Support v-prefixed versions.\n' > "$case_dir/fragments/v-prefix.fixed.md"
run_prepare "$case_dir/CHANGELOG.md" "$case_dir/fragments" "v0.4.0" "2026-04-26"
assert_contains "$case_dir/CHANGELOG.md" "## [0.4.0] - 2026-04-26"
assert_contains "$case_dir/CHANGELOG.md" "- Support v-prefixed versions."
